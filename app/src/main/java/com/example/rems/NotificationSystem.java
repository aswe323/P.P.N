...
public class NotificationSystem extends BroadcastReceiver { //create and scedual notification
    ...
    public static void scheduleNotification(Context context, long delay, int notificationRequestCode) {//this method creates notification,delay is after how much time(in millis) from current time you want to schedule the notification
        //build the notification
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context,"1")
                .setContentTitle("title lalala")
